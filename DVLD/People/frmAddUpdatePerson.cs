...
namespace DVLD.People
{
    public partial class frmAddUpdatePerson : Form
    {
            ...
            // place it in the images folder.
                ...
                if (_Person.ImagePath != pbPersonImage.ImageLocation)
                {
                    ...
                    if (pbPersonImage.ImageLocation != null)
                    {
                        ...
                        // source image file : the location of the image before copy
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (!this.ValidateChildren()) // if error provider discover something not valid
            {
        ...
        // General function to call in any thing required
        ...
        {
            // txtEmail is not required but if you put must be valid
        ...
        // to check that NationalNo is unique
